...
class JobParameters(BaseModel):
    ...
    # qubit_mapping: Optional[QubitMapping]

    shots: int = Field(...)
    max_circuit_duration_over_t2: Optional[float] = Field(None)
    heralding_mode: HeraldingMode = Field(...)
    move_validation_mode: MoveGateValidationMode = Field(...)
    move_gate_frame_tracking_mode: MoveGateFrameTrackingMode = Field(...)
